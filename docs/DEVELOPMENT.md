...
Engineering log for joystick's build: design decisions, verification runs, and the gap
between the original spec and what real Claude Code sessions actually do. Kept separate
from the main README so the product-facing doc stays short.
